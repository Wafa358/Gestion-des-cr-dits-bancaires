                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="margin-right:10%;float: right;">
                            <a href="{{url("ajouter-client")}}" class="btn btn-primary">Ajouter Client</a>
                        </div>
                            ...
                            <thead><tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$stu->télephone}}</td>
                                        <td>{{$stu->adresse}}</td>
                                        <td><a href="{{url('edit-client/'.$stu->id)}}" class="btn btn-primary">Edit</a> | <a href="{{url('delete-client/'.$stu->id)}}" class="btn btn-danger">Delete</a></td> 
                                    </tr>
                                    @endforeach
                                </tbody>
