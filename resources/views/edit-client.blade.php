            ...
            <div class="container" style="margin-top:20px">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form method="post" action="{{ url('update-client/'.$data->id) }}">
                            @csrf 
                            <div class="md-3">
                                <label class="form-label">Nom</label>
                                <input type="text" class="form-control" name="nom"
                                placeholder="Entrer le nom" value="{{$data->nom}}">
                                @error('nom')
                            ...
                            <div class="md-3">
                                ...
                                placeholder="Entrer le numéro" value="{{$data->télephone}}">
                                @error('télephone')
                                <div class="alert alert-danger" role="alert">
                                    {{$message}}
                            </div>
                            ...
                            <div class="md-3">
                                ...
                                placeholder="Entrer l'email" value="{{$data->email}}">
                                @error('email')
                                <div class="alert alert-danger" role="alert">
                                    {{$message}}
                            </div>
                            ...
                            <div class="md-3">
                                ...
                                placeholder="Entrer l'adresse">{{$data->adresse}}</textarea>
                                @error('adresse')
                                <div class="alert alert-danger" role="alert">
                                    {{$message}}
                            </div>
