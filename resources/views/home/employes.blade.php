            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 mx-auto">
                        <h1 class="text-center text-muted mb-3 mt-5">Employés</h1>

                        <form methode="POST" action="{{ route('employes') }}">
                            @csrf
                            ...
                            <div>
                                <x-input-label for="workstation" :value="__('Workstation')" />
                                <x-text-input id="workstation" class="block mt-1 w-full" type="text" name="workstation" :value="old('workstation')" required autofocus autocomplete="username" />
                                <x-input-error :messages="$errors->get('workstation')" class="mt-2" />
                            </div>
