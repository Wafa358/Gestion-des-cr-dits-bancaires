            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 mx-auto">
                        <h1 class="text-center text-muted mb-3 mt-5">Client</h1>
                        <p class="text-center text-muted mb-5"> Les coordonnées du client !</p>

                        <form methode="POST" action="{{ route('client') }}">
                            @csrf
