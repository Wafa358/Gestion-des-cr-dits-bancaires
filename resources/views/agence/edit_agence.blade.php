                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            ...
                            @endif
                            <form method="post" action="{{url('update-agence') }}">
                                @csrf
                                <div class="md-3">
                                    <input type="hidden" name="id" class="form-control" value="{{ $data->id }}" />
                                    <label>nom</label>
                                    <input type="text" name="prenom" class="form-control" placeholder="Entrer le nom" value="{{ $data->nom }}" />
                                    @error('nom')
                                ...
                                <div class="md-3">
                                    ...
                                    <input type="text" name="localisation" class="form-control" placeholder="Entrer la localisation" value="{{ $data->localisation }}" />
                                    @error('localisation')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
